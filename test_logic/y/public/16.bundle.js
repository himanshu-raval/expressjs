...
var achievement_service_1 = __webpack_require__(491);
var AchievementComponent = (function () {
    function AchievementComponent(achievementService, pagerService, modalService, alertService) {
    ...
    AchievementComponent.prototype.updateList = function () {
        var _this = this;
        this.achievementService.getAll()
            .subscribe(function (data) {
            if (data.status == 'success') {
    ...
    AchievementComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    AchievementComponent.prototype.submit = function () {
    ...
    AchievementComponent.prototype.setPage = function (page) {
    ...
    AchievementComponent.prototype.createAchievement = function () {
        var _this = this;
        ...
        this.achievementService.create(this.model)
            ...
            if (data.status == 'success') {
                ...
                _this.alertService.success('New Achievement created successfully', true);
                _this.model = {};
    ...
    AchievementComponent.prototype.editAchievement = function (index, content) {
        var _this = this;
    ...
    AchievementComponent.prototype.updateAchievement = function () {
        var _this = this;
        this.achievementService.update(this.model)
            ...
            if (data.status == 'success') {
                ...
                _this.alertService.success('Achievement Updated Successfully', true);
                _this.model = {};
                _this.modalRef.close();
            }
            else {
    ...
    AchievementComponent.prototype.deleteAchievement = function (index) {
        var _this = this;
        index = index + ((this.currentPage - 1) * this.pageSize);
        ...
        this.achievementService.delete(this.allItems[index].id)
            ...
            if (data.status == 'success') {
                ...
                _this.alertService.success('Achievement Deleted Successfuly', true);
            }
            else {
                _this.alertService.error(data.message, true);
            }
...
var AchievementService = (function () {
    ...
    AchievementService.prototype.getAll = function () {
        return this.http.get('/Achievement/Achievement').map(function (response) { return response.json(); });
    };
    AchievementService.prototype.create = function (achievement) {
        return this.http.post('/Achievement/Achievement', achievement).map(function (response) { return response.json(); });
    };
    AchievementService.prototype.update = function (achievement) {
        console.log('Edit Work');
        return this.http.put('/Achievement/Achievement/' + achievement.id, achievement).map(function (response) { return response.json(); });
    };
    AchievementService.prototype.getById = function (_id) {
        return this.http.get('/Achievement/Achievement/' + _id).map(function (response) { return response.json(); });
    };
    AchievementService.prototype.delete = function (_id) {
        return this.http.delete('/Achievement/Achievement/' + _id).map(function (response) { return response.json(); });
    };
...
var achievement_component_1 = __webpack_require__(490);
var routes = [
    { path: '', component: achievement_component_1.AchievementComponent }
];
var AchievementRoutingModule = (function () {
    function AchievementRoutingModule() {
    }
    AchievementRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], AchievementRoutingModule);
    return AchievementRoutingModule;
}());
exports.AchievementRoutingModule = AchievementRoutingModule;
...
var achievement_routing_module_1 = __webpack_require__(521);
var achievement_component_1 = __webpack_require__(490);
var achievement_service_1 = __webpack_require__(491);
    ...
    AchievementModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                achievement_routing_module_1.AchievementRoutingModule,
                page_header_module_1.PageHeaderModule,
                forms_1.FormsModule,
                ng_bootstrap_1.NgbPaginationModule.forRoot()
            ],
            declarations: [achievement_component_1.AchievementComponent],
            providers: [
                pager_service_1.PagerService,
