...
var coin_service_1 = __webpack_require__(509);
...
var CoinComponent = (function () {
    function CoinComponent(coinService, pagerService, modalService, alertService) {
        ...
        /* image Upload */
        this.uploader = new ng2_file_upload_1.FileUploader({ url: app_config_1.Config.apiUrl + '/Shop/Coin/api/upload' });
    ...
    CoinComponent.prototype.updateList = function () {
        var _this = this;
        this.coinService.getAll()
            .subscribe(function (data) {
            if (data.status == 'success') {
    ...
    */
    CoinComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    CoinComponent.prototype.fileOverAnother = function (e) {
        this.hasAnotherDropZoneOver = e;
    };
    /*
   * image Upload code End Here
   */
    CoinComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    CoinComponent.prototype.submit = function () {
    ...
    CoinComponent.prototype.setPage = function (page) {
    ...
    CoinComponent.prototype.deleteCoin = function (index) {
        var _this = this;
    ...
    CoinComponent.prototype.editCoin = function (index, content) {
        var _this = this;
    ...
    CoinComponent.prototype.createCoin = function () {
        var _this = this;
        this.coinService.create(this.model)
            ...
            if (data.status == 'success') {
                ...
                _this.alertService.success('New Coin created successfully', true);
                _this.model = {};
    ...
    CoinComponent.prototype.updateCoin = function () {
        var _this = this;
...
var CoinService = (function () {
    ...
    CoinService.prototype.getAll = function () {
        return this.http.get('/Shop/Coin/api/').map(function (response) { return response.json(); });
    };
    CoinService.prototype.getById = function (_id) {
        return this.http.get('/Shop/Coin/api/' + _id).map(function (response) { return response.json(); });
    };
    CoinService.prototype.create = function (coin) {
        return this.http.post('/Shop/Coin/api/', coin).map(function (response) { return response.json(); });
    };
    CoinService.prototype.update = function (coin) {
        return this.http.put('/Shop/Coin/api/' + coin.id, coin).map(function (response) { return response.json(); });
    };
    CoinService.prototype.delete = function (_id) {
        return this.http.delete('/Shop/Coin/api/' + _id).map(function (response) { return response.json(); });
    };
...
var coin_component_1 = __webpack_require__(508);
var routes = [
    { path: '', component: coin_component_1.CoinComponent }
];
var CoinRoutingModule = (function () {
    function CoinRoutingModule() {
    }
    CoinRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], CoinRoutingModule);
    return CoinRoutingModule;
}());
exports.CoinRoutingModule = CoinRoutingModule;
...
var coin_routing_module_1 = __webpack_require__(544);
var coin_component_1 = __webpack_require__(508);
var coin_service_1 = __webpack_require__(509);
var page_header_module_1 = __webpack_require__(236);
var pager_service_1 = __webpack_require__(480);
var CoinModule = (function () {
    function CoinModule() {
    }
