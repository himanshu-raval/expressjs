...
var wheel_service_1 = __webpack_require__(520);
var WheelComponent = (function () {
    function WheelComponent(wheelService, modalService, alertService) {
    ...
    WheelComponent.prototype.open = function (content) {
    ...
    WheelComponent.prototype.submit = function () {
    ...
    WheelComponent.prototype.createSlice = function () {
        var _this = this;
        this.wheelService.create(this.model)
            .subscribe(function (data) {
            if (data.status == 'success') {
                _this.allItems.push(data.result);
                _this.alertService.success('New slice created successfully', true);
                _this.model = {};
    ...
    WheelComponent.prototype.editSlice = function (index, content) {
        var _this = this;
    ...
    WheelComponent.prototype.updateSlice = function () {
        var _this = this;
        this.wheelService.update(this.model)
            .subscribe(function (data) {
            if (data.status == 'success') {
                _this.allItems[_this.editIndex] = data.result;
                _this.alertService.success('Slice updated successfuly', true);
                _this.model = {};
                _this.modalRef.close();
            }
            else {
    ...
    WheelComponent.prototype.deleteSlice = function (index) {
        var _this = this;
        this.wheelService.delete(this.allItems[index].id)
            .subscribe(function (data) {
            if (data.status == 'success') {
                _this.allItems.splice(index, 1);
                _this.alertService.success('Help updated successfuly', true);
            }
            else {
                _this.alertService.error(data.message, true);
            }
...
var WheelService = (function () {
    ...
    WheelService.prototype.getAll = function () {
        return this.http.get('/Wheel/Slice').map(function (response) { return response.json(); });
    };
    WheelService.prototype.getById = function (_id) {
        return this.http.get('/Wheel/Slice/' + _id).map(function (response) { return response.json(); });
    };
    WheelService.prototype.create = function (wheel) {
        return this.http.post('/Wheel/Slice', wheel).map(function (response) { return response.json(); });
    };
    WheelService.prototype.update = function (wheel) {
        return this.http.put('/Wheel/Slice/' + wheel.id, wheel).map(function (response) { return response.json(); });
    };
    WheelService.prototype.delete = function (_id) {
        return this.http.delete('/Wheel/Slice/' + _id).map(function (response) { return response.json(); });
    };
...
var wheel_component_1 = __webpack_require__(519);
var routes = [
    { path: '', component: wheel_component_1.WheelComponent }
];
var WheelRoutingModule = (function () {
    function WheelRoutingModule() {
    }
    WheelRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], WheelRoutingModule);
    return WheelRoutingModule;
}());
exports.WheelRoutingModule = WheelRoutingModule;
...
var wheel_routing_module_1 = __webpack_require__(556);
var wheel_component_1 = __webpack_require__(519);
var wheel_service_1 = __webpack_require__(520);
var page_header_module_1 = __webpack_require__(236);
var pager_service_1 = __webpack_require__(480);
var WheelModule = (function () {
    function WheelModule() {
    }
    WheelModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule,
                wheel_routing_module_1.WheelRoutingModule,
                page_header_module_1.PageHeaderModule,
                ng_bootstrap_1.NgbPaginationModule.forRoot(),
                forms_1.FormsModule
            ],
            declarations: [wheel_component_1.WheelComponent],
            providers: [
                pager_service_1.PagerService,
                wheel_service_1.WheelService
            ],
        })
    ], WheelModule);
    return WheelModule;
