...
var help_service_1 = __webpack_require__(499);
var help_model_1 = __webpack_require__(534);
var HelpComponent = (function () {
    function HelpComponent(helpService, alertService) {
        this.helpService = helpService;
        this.alertService = alertService;
        this.help = new help_model_1.Help();
    }
    ...
    HelpComponent.prototype.updateHelp = function () {
        var _this = this;
...
var HelpService = (function () {
    ...
    HelpService.prototype.get = function () {
        return this.http.get('/Help/Help').map(function (response) { return response.json(); });
    };
    HelpService.prototype.update = function (help) {
        return this.http.put('/Help/Help', help).map(function (response) { return response.json(); });
    };
...
var help_component_1 = __webpack_require__(498);
var routes = [
...
var ng2_ckeditor_1 = __webpack_require__(238);
var forms_1 = __webpack_require__(24);
var help_routing_module_1 = __webpack_require__(533);
var help_component_1 = __webpack_require__(498);
var help_service_1 = __webpack_require__(499);
...
module.exports = "<app-page-header [heading]=\"'Helps'\" [icon]=\"'fa-table'\"></app-page-header>\n<div class=\"row\">\n  <div class=\"col col-xl-12 col-lg-12\">\n    <div class=\"card mb-3\">\n      <div class=\"card-header\">\n        <button class=\"btn btn-primary pull-right\" (click)=\"updateHelp()\">\n          <i class=\"fa fa-save\"></i> Update\n        </button>\n        Help Content\n      </div>\n      <div class=\"card-block table-responsive\">\n      <ckeditor\n      [(ngModel)]=\"help.text\"\n      [config]=\"{uiColor: '#AADC6E'}\"\n      debounce=\"500\">\n    </ckeditor>\n           <!-- <ckeditor\n               [(ngModel)]=\"ckeditorContent\"\n               [config]=\"{uiColor: '#AADC6E'}\"\n               (change)=\"onChange($event)\"\n               (ready)=\"onReady($event)\"\n               (focus)=\"onFocus($event)\"\n               (blur)=\"onBlur($event)\"\n               debounce=\"500\">\n             </ckeditor> -->\n           </div>\n         </div>\n       </div>\n     </div>"
