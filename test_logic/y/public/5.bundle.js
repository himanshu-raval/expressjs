...
var landmark_service_1 = __webpack_require__(513);
...
var LandmarkComponent = (function () {
    function LandmarkComponent(landmarkService, pagerService, modalService, alertService) {
        ...
        /* image Upload */
        this.uploader = new ng2_file_upload_1.FileUploader({ url: app_config_1.Config.apiUrl + '/Shop/Landmark/api/upload' });
    ...
    LandmarkComponent.prototype.updateList = function () {
        var _this = this;
        this.landmarkService.getAll()
            .subscribe(function (data) {
            if (data.status == 'success') {
    ...
    */
    LandmarkComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    LandmarkComponent.prototype.fileOverAnother = function (e) {
        this.hasAnotherDropZoneOver = e;
    };
    /*
   * image Upload code End Here
   */
    LandmarkComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    LandmarkComponent.prototype.submit = function () {
    ...
    LandmarkComponent.prototype.setPage = function (page) {
    ...
    LandmarkComponent.prototype.deleteLandmark = function (index) {
        var _this = this;
    ...
    LandmarkComponent.prototype.editLandmark = function (index, content) {
        var _this = this;
    ...
    LandmarkComponent.prototype.createLandmark = function () {
        var _this = this;
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            if (res.status == 'success') {
                //console.log(res)
                _this.model.landmark = res.result.filename;
                console.log(_this.model);
                _this.landmarkService.create(_this.model)
                    .subscribe(function (data) {
                    ...
                    if (data.status == 'success') {
                        ...
                        _this.alertService.success('New Landmark created successfully', true);
                        _this.model = {};
    ...
    LandmarkComponent.prototype.updateLandmark = function () {
        var _this = this;
        if (this.uploader.queue[0]) {
            ...
            this.uploader.onCompleteItem = function (item, response, status, headers) {
                ...
                if (res.status == 'success') {
                    _this.model.landmark = res.result.filename;
                    _this.landmarkService.update(_this.model)
                        .subscribe(function (data) {
                        if (data.status == 'success') {
...
exports.LandmarkComponent = LandmarkComponent;
...
var LandmarkService = (function () {
    ...
    LandmarkService.prototype.getAll = function () {
        return this.http.get('/Shop/Landmark/api/').map(function (response) { return response.json(); });
    };
    LandmarkService.prototype.getById = function (_id) {
        return this.http.get('/Shop/Landmark/api/' + _id).map(function (response) { return response.json(); });
    };
    LandmarkService.prototype.create = function (landmark) {
        return this.http.post('/Shop/Landmark/api/', landmark).map(function (response) { return response.json(); });
    };
    LandmarkService.prototype.update = function (landmark) {
        return this.http.put('/Shop/Landmark/api/' + landmark.id, landmark).map(function (response) { return response.json(); });
    };
    LandmarkService.prototype.delete = function (_id) {
        return this.http.delete('/Shop/Landmark/api/' + _id).map(function (response) { return response.json(); });
    };
...
var landmark_component_1 = __webpack_require__(512);
var routes = [
    { path: '', component: landmark_component_1.LandmarkComponent }
];
var LandmarkRoutingModule = (function () {
...
exports.LandmarkRoutingModule = LandmarkRoutingModule;
...
var landmark_routing_module_1 = __webpack_require__(548);
var landmark_component_1 = __webpack_require__(512);
var landmark_service_1 = __webpack_require__(513);
    ...
    LandmarkModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                landmark_routing_module_1.LandmarkRoutingModule,
                page_header_module_1.PageHeaderModule,
                forms_1.FormsModule,
                ng2_file_upload_1.FileUploadModule,
                ng_bootstrap_1.NgbPaginationModule.forRoot()
            ],
            declarations: [landmark_component_1.LandmarkComponent],
            providers: [
                pager_service_1.PagerService,
