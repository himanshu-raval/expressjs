...
var gems_service_1 = __webpack_require__(511);
var alert_service_1 = __webpack_require__(132);
var app_config_1 = __webpack_require__(237);
var GemsComponent = (function () {
    function GemsComponent(gemsService, pagerService, modalService, alertService) {
        ...
        /* image Upload */
        this.uploader = new ng2_file_upload_1.FileUploader({ url: app_config_1.Config.apiUrl + '/Shop/Gems/api/upload' });
        this.hasBaseDropZoneOver = false;
        this.hasAnotherDropZoneOver = false;
    }
    GemsComponent.prototype.ngOnInit = function () {
    ...
    */
    GemsComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    GemsComponent.prototype.fileOverAnother = function (e) {
        this.hasAnotherDropZoneOver = e;
    };
    /*
    * image Upload code End Here
    */
    GemsComponent.prototype.updateList = function () {
        var _this = this;
        this.gemsService.getAll()
            .subscribe(function (data) {
            console.log(data);
    ...
    GemsComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    GemsComponent.prototype.submit = function () {
    ...
    GemsComponent.prototype.setPage = function (page) {
    ...
    GemsComponent.prototype.editGems = function (index, content) {
        var _this = this;
    ...
    GemsComponent.prototype.deleteGems = function (index) {
        var _this = this;
    ...
    GemsComponent.prototype.createGems = function () {
        var _this = this;
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            if (res.status == 'success') {
                //console.log(res)
                _this.model.gems = res.result.filename;
                //console.log(this.model)
                _this.gemsService.create(_this.model)
                    .subscribe(function (data) {
                    ...
                    if (data.status == 'success') {
                        ...
                        _this.updateList();
                        _this.alertService.success('New Gems created successfully', true);
                        _this.model = {};
    ...
    GemsComponent.prototype.updateGems = function () {
        var _this = this;
        if (this.uploader.queue[0]) {
            ...
            this.uploader.onCompleteItem = function (item, response, status, headers) {
                ...
                if (res.status == 'success') {
                    _this.model.gems = res.result.filename;
                    _this.gemsService.update(_this.model)
                        .subscribe(function (data) {
                        // console.log("With Image",data);
                        if (data.status == 'success') {
                            _this.allItems[_this.editIndex] = data.result;
                            _this.alertService.success('Gems Updated Successfully', true);
                            _this.model = {};
                            _this.modalRef.close();
                        }
                        else {
...
exports.GemsComponent = GemsComponent;
...
var GemsService = (function () {
    function GemsService(http) {
        this.http = http;
    }
    GemsService.prototype.getAll = function () {
        console.log("Get All Called");
        return this.http.get('/Shop/Gems/api/').map(function (response) { return response.json(); });
    };
    GemsService.prototype.getById = function (_id) {
        return this.http.get('/Shop/Gems/api/' + _id).map(function (response) { return response.json(); });
    };
    GemsService.prototype.create = function (gems) {
        return this.http.post('/Shop/Gems/api/', gems).map(function (response) { return response.json(); });
    };
    GemsService.prototype.update = function (gems) {
        console.log("Gemst Upadte Called");
        return this.http.put('/Shop/Gems/api/' + gems.id, gems).map(function (response) { return response.json(); });
    };
    GemsService.prototype.delete = function (_id) {
        return this.http.delete('/Shop/Gems/api/' + _id).map(function (response) { return response.json(); });
    };
    GemsService = __decorate([
        core_1.Injectable(),
...
var gems_component_1 = __webpack_require__(510);
var routes = [
    { path: '', component: gems_component_1.GemsComponent }
];
var GemsRoutingModule = (function () {
    function GemsRoutingModule() {
    }
    GemsRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], GemsRoutingModule);
    return GemsRoutingModule;
}());
exports.GemsRoutingModule = GemsRoutingModule;
...
var gems_routing_module_1 = __webpack_require__(546);
var gems_component_1 = __webpack_require__(510);
var gems_service_1 = __webpack_require__(511);
var page_header_module_1 = __webpack_require__(236);
var pager_service_1 = __webpack_require__(480);
var GemsModule = (function () {
    function GemsModule() {
    }
    GemsModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule,
                gems_routing_module_1.GemsRoutingModule,
                page_header_module_1.PageHeaderModule,
                forms_1.FormsModule,
                ng2_file_upload_1.FileUploadModule,
                ng_bootstrap_1.NgbPaginationModule.forRoot()
            ],
            declarations: [gems_component_1.GemsComponent],
            providers: [
                pager_service_1.PagerService,
                gems_service_1.GemsService
            ],
        })
    ], GemsModule);
    return GemsModule;
