...
var chest_service_1 = __webpack_require__(507);
...
var ChestComponent = (function () {
    function ChestComponent(chestService, pagerService, modalService, alertService) {
        ...
        this.cbavatar = false;
        this.cbcard = false;
        this.cblandmard = false;
        /* image Upload */
        this.uploader = new ng2_file_upload_1.FileUploader({ url: app_config_1.Config.apiUrl + '/Shop/Chest/api/upload' });
        this.hasBaseDropZoneOver = false;
        this.hasAnotherDropZoneOver = false;
    }
    ChestComponent.prototype.ngOnInit = function () {
        var _this = this;
        // get dummy data
    ...
    ChestComponent.prototype.updateList = function () {
        var _this = this;
        this.chestService.getAll()
            .subscribe(function (data) {
            if (data.status == 'success') {
    ...
    */
    ChestComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    ChestComponent.prototype.fileOverAnother = function (e) {
        this.hasAnotherDropZoneOver = e;
    };
    /*
   * image Upload code End Here
   */
    ChestComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    ChestComponent.prototype.submit = function () {
    ...
    ChestComponent.prototype.setPage = function (page) {
    ...
    ChestComponent.prototype.deleteChest = function (index) {
        var _this = this;
    ...
    ChestComponent.prototype.editChest = function (index, content) {
        var _this = this;
    ...
    ChestComponent.prototype.createChest = function () {
        var _this = this;
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            if (res.status == 'success') {
                //console.log(res)
                _this.model.chest = res.result.filename;
                //console.log(this.model)
                if (!_this.model.avatar)
                    _this.model.avatar = false;
                if (!_this.model.card)
                    _this.model.card = false;
                if (!_this.model.landmark)
                    _this.model.landmark = false;
                console.log(_this.model);
                _this.chestService.create(_this.model)
                    .subscribe(function (data) {
                    ...
                    if (data.status == 'success') {
                        ...
                        _this.alertService.success('New Chest created successfully', true);
                        _this.model = {};
    ...
    ChestComponent.prototype.updateChest = function () {
        var _this = this;
        if (this.uploader.queue[0]) {
            ...
            this.uploader.onCompleteItem = function (item, response, status, headers) {
                ...
                if (res.status == 'success') {
                    ...
                    if (!_this.model.landmark)
                        _this.model.landmark = false;
                    _this.chestService.update(_this.model)
                        .subscribe(function (data) {
                        if (data.status == 'success') {
    ...
    ChestComponent = __decorate([
        core_1.Component({
            selector: 'chest-page',
            template: __webpack_require__(571),
            styles: [__webpack_require__(592)],
        }),
        __metadata("design:paramtypes", [chest_service_1.ChestService,
...
var ChestService = (function () {
    function ChestService(http) {
        this.http = http;
    }
    ChestService.prototype.getAll = function () {
        return this.http.get('/Shop/Chest/api/').map(function (response) { return response.json(); });
    };
    ChestService.prototype.getById = function (_id) {
        return this.http.get('/Shop/Chest/api/' + _id).map(function (response) { return response.json(); });
    };
    ChestService.prototype.create = function (chest) {
        return this.http.post('/Shop/Chest/api/', chest).map(function (response) { return response.json(); });
    };
    ChestService.prototype.update = function (chest) {
        return this.http.put('/Shop/Chest/api/' + chest.id, chest).map(function (response) { return response.json(); });
    };
    ChestService.prototype.delete = function (_id) {
        return this.http.delete('/Shop/Chest/api/' + _id).map(function (response) { return response.json(); });
    };
    ChestService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http])
    ], ChestService);
    return ChestService;
}());
exports.ChestService = ChestService;
...
var chest_component_1 = __webpack_require__(506);
var routes = [
    { path: '', component: chest_component_1.ChestComponent }
];
var ChestRoutingModule = (function () {
    function ChestRoutingModule() {
    }
    ChestRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], ChestRoutingModule);
    return ChestRoutingModule;
}());
exports.ChestRoutingModule = ChestRoutingModule;
...
var chest_routing_module_1 = __webpack_require__(542);
var chest_component_1 = __webpack_require__(506);
var chest_service_1 = __webpack_require__(507);
var page_header_module_1 = __webpack_require__(236);
var pager_service_1 = __webpack_require__(480);
var ChestModule = (function () {
    function ChestModule() {
    }
    ChestModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule,
                chest_routing_module_1.ChestRoutingModule,
                page_header_module_1.PageHeaderModule,
                forms_1.FormsModule,
                ng2_file_upload_1.FileUploadModule,
                ng_bootstrap_1.NgbPaginationModule.forRoot()
            ],
            declarations: [chest_component_1.ChestComponent],
            providers: [
                pager_service_1.PagerService,
                chest_service_1.ChestService
            ],
        })
    ], ChestModule);
    return ChestModule;
}());
exports.ChestModule = ChestModule;
