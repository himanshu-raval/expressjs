...
var avatar_service_1 = __webpack_require__(503);
var alert_service_1 = __webpack_require__(132);
var app_config_1 = __webpack_require__(237);
var AvatarComponent = (function () {
    function AvatarComponent(avatarService, pagerService, modalService, alertService) {
        ...
        /* image Upload */
        this.uploader = new ng2_file_upload_1.FileUploader({ url: app_config_1.Config.apiUrl + '/Shop/Avatar/api/upload' });
    ...
    */
    AvatarComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    AvatarComponent.prototype.fileOverAnother = function (e) {
        this.hasAnotherDropZoneOver = e;
    };
    /*
    * image Upload code End Here
    */
    AvatarComponent.prototype.updateList = function () {
        var _this = this;
        this.avatarService.getAll()
            .subscribe(function (data) {
            console.log(data);
    ...
    AvatarComponent.prototype.open = function (content) {
        this.modalRef = this.modalService.open(content);
    };
    AvatarComponent.prototype.submit = function () {
    ...
    AvatarComponent.prototype.setPage = function (page) {
    ...
    AvatarComponent.prototype.editAvatar = function (index, content) {
        var _this = this;
    ...
    AvatarComponent.prototype.deleteAvatar = function (index) {
        var _this = this;
    ...
    AvatarComponent.prototype.createAvatar = function () {
        var _this = this;
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            if (res.status == 'success') {
                //console.log(res)
                _this.model.avatar = res.result.filename;
                //console.log(this.model)
                _this.avatarService.create(_this.model)
                    .subscribe(function (data) {
                    ...
                    if (data.status == 'success') {
                        ...
                        _this.updateList();
                        _this.alertService.success('New Avatar created successfully', true);
                        _this.model = {};
    ...
    AvatarComponent.prototype.updateAvatar = function () {
        var _this = this;
        if (this.uploader.queue[0]) {
            ...
            this.uploader.onCompleteItem = function (item, response, status, headers) {
                ...
                if (res.status == 'success') {
                    _this.model.avatar = res.result.filename;
                    _this.avatarService.update(_this.model)
                        .subscribe(function (data) {
                        // console.log("With Image",data);
                        if (data.status == 'success') {
                            _this.allItems[_this.editIndex] = data.result;
                            _this.alertService.success('Avatar Updated Successfully', true);
                            _this.model = {};
                            _this.modalRef.close();
                        }
                        else {
...
var AvatarService = (function () {
    ...
    AvatarService.prototype.getAll = function () {
        return this.http.get('/Shop/Avatar/api/').map(function (response) { return response.json(); });
    };
    AvatarService.prototype.getById = function (_id) {
        return this.http.get('/Shop/Avatar/api/' + _id).map(function (response) { return response.json(); });
    };
    AvatarService.prototype.create = function (avatar) {
        return this.http.post('/Shop/Avatar/api/', avatar).map(function (response) { return response.json(); });
    };
    AvatarService.prototype.update = function (avatar) {
        console.log("Avatart Upadte Called");
        return this.http.put('/Shop/Avatar/api/' + avatar.id, avatar).map(function (response) { return response.json(); });
    };
    AvatarService.prototype.delete = function (_id) {
        return this.http.delete('/Shop/Avatar/api/' + _id).map(function (response) { return response.json(); });
    };
...
var avatar_component_1 = __webpack_require__(502);
var routes = [
    { path: '', component: avatar_component_1.AvatarComponent }
];
var AvatarRoutingModule = (function () {
    function AvatarRoutingModule() {
    }
    AvatarRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], AvatarRoutingModule);
    return AvatarRoutingModule;
}());
exports.AvatarRoutingModule = AvatarRoutingModule;
...
var avatar_routing_module_1 = __webpack_require__(538);
var avatar_component_1 = __webpack_require__(502);
var avatar_service_1 = __webpack_require__(503);
    ...
    AvatarModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                avatar_routing_module_1.AvatarRoutingModule,
