...
var player_service_1 = __webpack_require__(501);
var PlayerComponent = (function () {
    function PlayerComponent(playerService, pagerService) {
    ...
    PlayerComponent.prototype.setPage = function (page) {
    ...
    PlayerComponent.prototype.deletePlayer = function (index) {
        var _this = this;
    ...
    PlayerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [player_service_1.PlayerService, pager_service_1.PagerService])
    ], PlayerComponent);
...
var PlayerService = (function () {
    ...
    PlayerService.prototype.getAll = function () {
        return this.http.get('/Player/Player').map(function (response) { return response.json(); });
    };
    PlayerService.prototype.getById = function (_id) {
        return this.http.get('/Player/Player/' + _id).map(function (response) { return response.json(); });
    };
    ...
    PlayerService.prototype.delete = function (_id) {
        return this.http.delete('/Player/Player/' + _id).map(function (response) { return response.json(); });
    };
...
var player_component_1 = __webpack_require__(500);
var routes = [
...
var player_routing_module_1 = __webpack_require__(536);
var player_component_1 = __webpack_require__(500);
var player_service_1 = __webpack_require__(501);
